...
<html>
	...
	<body>
		<div id="centre">
			<h1><img src="<?php echo SITE_URL; ?>/front_end/loginpage/images/johnny'sapple.png" height="38px" width="38px"> TaxiPing</h1>
			<section id="formBox_password">
				<h2>Registration</h2>
				<p>Please Enter your information to create a TaxiPing account. Then select submit.</p>
